...
/**
 * test Incident Bee Happy not logging
 */
class BeeHappyNotLogged : ExampleSystemTestExtension() {
    override val name = "BeeHappyPotatoNotLogged"
    override val description = "test not logging bee happy incident on potato"
    ...
    override suspend fun run() {
        ...
        assertNextLine("[IMPORTANT] Incident: Incident 12 of type BEE_HAPPY happened and affected tiles .")
    }
}
