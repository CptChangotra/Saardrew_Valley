 ...
 */
class HarvestLogTest2 : ExampleSystemTestExtension() {
    override val name = "Harvest Log 2"
    override val description = "Tests logging of harvest changed because of missed actions 2"
