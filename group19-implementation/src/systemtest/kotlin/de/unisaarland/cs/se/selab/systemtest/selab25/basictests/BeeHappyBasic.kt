...
[DEBUG] Cloud Movement: On tile 2, the amount of sunlight is 137.
[INFO] Cloud Movement: Cloud 3 with 1000 L water moved from tile 3 to tile 6.
[DEBUG] Cloud Movement: On tile 3, the amount of sunlight is 137.
[DEBUG] Cloud Position: Cloud 1 is on tile 0, where the amount of sunlight is 90.
...
[IMPORTANT] Farm Action: Machine 0 performs MOWING on tile 7 for 2 days.
[IMPORTANT] Farm Machine: Machine 0 is finished and returns to the shed at 12.
[IMPORTANT] Farm: Farm 0 finished its actions.
[IMPORTANT] Incident: Incident 1 of type CITY_EXPANSION happened and affected tiles 10.
[INFO] Cloud Dissipation: Cloud 2 got stuck on tile 10.
[INFO] Harvest Estimate: Harvest estimate on tile 2 changed to 1239300 g of APPLE.
...
[IMPORTANT] Farm: Farm 0 finished its actions.
[IMPORTANT] Incident: Incident 2 of type BEE_HAPPY happened and affected tiles 2.
[INFO] Harvest Estimate: Harvest estimate on tile 2 changed to 1355173 g of APPLE.
...
[IMPORTANT] Farm Machine: Machine 1 is finished and returns to the shed at 16.
[IMPORTANT] Farm: Farm 0 finished its actions.
[INFO] Harvest Estimate: Harvest estimate on tile 2 changed to 889128 g of APPLE.
...
[IMPORTANT] Simulation Statistics: Total harvest estimate still in fields and plantations: 4789128 g.
"""

/**
 * System test for Bee Happy Incident.
 */
class BeeHappyBasic : ExampleSystemTestExtension() {
    override val name = "Bee Happy Basic"
    override val description = "Test for Bee Happy"

    override val map = "DroughtThenBeeHappy/IncidentMix_BeeHappyMap.json"
    override val farms = "DroughtThenBeeHappy/IncidentMix_FarmBigger.json"
    override val scenario = "DroughtThenBeeHappy/IncidentMix_BeeHappyScenario.json"
    ...
    override suspend fun run() {
        ...
        skipUntilString(
            "[INFO] Initialization Info: IncidentMix_BeeHappyScenario.json successfully parsed and validated."
        )
